...
<nav class="desktop-nav">
    <div class="max-w-6xl mx-auto px-4 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-2">
            ...
            $logo_path = '/r/img/logo.webp'; // Valor padrão
            ...
            <div class="flex gap-3 items-center desktop-user-section">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute hidden group-hover:block bg-gray-700 mt-1 rounded shadow-md w-40 right-0">
                        <a href="/r/perfil.php" class="block px-4 py-2 hover:bg-gray-600 transition-colors">Perfil</a>
                        <a href="/r/perfil.php" class="block px-4 py-2 hover:bg-gray-600 transition-colors">Sacar</a>
                        <a href="/r/logout.php" class="block px-4 py-2 hover:bg-gray-600 transition-colors">Sair</a>
                    </div>
                </div>
            </div>
        <?php else: ?>
